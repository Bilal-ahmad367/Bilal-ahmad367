<template>
    <header class="z-40" :class="{ dark: store.semidark && store.menu === 'horizontal' }">
        <div class="shadow-sm">
            ...
            <div>
              <img v-if="hotel?.logoUrl" :src="hotel.logoUrl" alt="Hotel Logo" class="w-8 ml-[5px] flex-none"/>
            </div>
            ...
            >
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <router-link to="/hotel-dashboard/add-item">{{ $t('Add item') }}</router-link>
                        </li>
                        <li>
                            <router-link to="/hotel-dashboard/list-items">{{ $t('List items') }}</router-link>
                        </li>
                        <li>
                            <router-link to="/hotel-dashboard/orders">{{ $t('Orders') }}</router-link>
                        </li>
                    </ul>
               </li>
            </ul>
