      ...
      >
        ...
        >
          ...
          <div class="w-full max-w-[440px] lg:mt-16">
            ...
            <form class="space-y-5 dark:text-white" @submit.prevent="Register">
              ...
              >
                ...
                <div class="relative text-white-dark">
                  <input
                    v-model.trim="$v.registration.name.$model"
                    id="Name"
                    type="text"
                ...
                <template
                  v-if="isSubmitregistration && !$v.registration.name.$error"
                >
              ...
              >
                ...
                <div class="relative text-white-dark">
                  <input
                    v-model.trim="$v.registration.email.$model"
                    id="Email"
                    type="email"
                ...
                <template
                  v-if="isSubmitregistration && !$v.registration.email.$error"
                >
                  <p class="text-[#1abc9c] mt-1">Looks Good!</p>
                </template>
                <template
              ...
              >
                ...
                <div class="relative text-white-dark">
                  <input
                    v-model.trim="$v.registration.password.$model"
                    id="Password"
                    type="password"
                ...
                <template
                  v-if="isSubmitregistration && $v.registration.password.$error"
                >
            ...
            <!-- Loading Indicator -->
            <div v-if="loader" class="text-green-500 mt-4 ">
              <p>Loading ....</p>
            </div>
...
const Register = async () => {
  ...
  const postData = registration.value;
  loader.value = true;
