      ...
      <div
        ...
        <div
          ...
          <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
            ...
            <router-link to="/login" class="w-48 block lg:w-72 ms-10">
                ...
                <template #content="{ close }">
                  <ul
                    ...
                    <template v-for="item in store.languageList" :key="item.code">
                      <li>
                        <button type="button" class="w-full hover:text-primary" :class="{
          ...
          <div class="w-full max-w-[440px] lg:mt-16">
            ...
            <form class="space-y-5 dark:text-white" @submit.prevent="registerUser">
              ...
              <div :class="{
                ...
                'has-success':
                  isSubmitregistration && !$v.registration.name.$error,
              }">
                <label for="name">Name </label>
                <div class="relative text-white-dark">
                  <input v-model.trim="$v.registration.name.$model" id="name" type="text" placeholder="Enter name"
              ...
              <div :class="{
                ...
                'has-success':
                  isSubmitregistration && !$v.registration.email.$error,
              }">
                <label for="Email">Email</label>
                <div class="relative text-white-dark">
                  <input v-model.trim="$v.registration.email.$model" id="Email" type="email" placeholder="Enter Email"
                    class="form-input ps-10 placeholder:text-white-dark" />
                  <span class="absolute start-4 top-1/2 -translate-y-1/2">
                    <icon-mail :fill="true" />
                  </span>
              ...
              <div :class="{
                ...
                'has-success':
                  isSubmitregistration && !$v.registration.password.$error,
              }">
                <label for="Password">Password</label>
                <div class="relative text-white-dark">
                  <input v-model.trim="$v.registration.password.$model" id="password" type="password"
              ...
              <div :class="{
                ...
                <div class="relative text-white-dark">
                  <input v-model.trim="$v.registration.confirmpassword.$model" id="confirmpassword" type="password"
                    placeholder="Confirm Password" class="form-input ps-10 placeholder:text-white-dark" />
                  <span class="absolute start-4 top-1/2 -translate-y-1/2">
                    <icon-lock-dots :fill="true" />
                  </span>
                </div>
